                ...
                <carousel-controller>
                    <q-carousel-slide class='bg-white'>
                        <h3 class='text-center text-weight-medium'>
                            Vamos falar sobre
                            <big class='text-primary'>DIGITAÇÃO</big>.
                            <p>Vamos entender como isso funciona.</p>
                        </h3>
                    </q-carousel-slide>
                    <q-carousel-slide class='bg-white'>
                        <h3 class='text-center text-weight-medium'>
                            A digitação é feita através do teclado:
                            <img :src='imagem1' height='80%' width='100%'>
                        </h3>
                    </q-carousel-slide>
                    <q-carousel-slide class='bg-white'>
                    ...
                    <q-carousel-slide class='bg-white'>
                        <h3 class='text-center text-weight-medium'>
                            <p>Na próxima tela, digite <span class='text-primary'>1234567890</span> e passe para a próxima tela, onde iremos verificar se foi digitado corretamente.
                            </p>
                        </h3>
                    </q-carousel-slide>
                    <q-carousel-slide class='bg-white'>
                        <br>
                        <q-input class='q-title text-center' v-model='teste4' type='number' float-label="APERTE AQUI PARA COMEÇAR" placeholder="DIGITE 1234567890" clearable align='center'></q-input>
                        <h3 class='text-center text-weight-medium'>Aperte na linha acima e digite 1234567890! Passe para a
                            <span class='text-green'>PRÓXIMA</span> tela para verificar
                        </h3>
                    </q-carousel-slide>
                    ...
                    <q-carousel-slide class='bg-white'>
                     ...
                     <q-carousel-slide class='bg-white'>
                        <br>
                        <q-input class='q-title text-center' v-model='teste6' float-label="APERTE AQUI PARA COMEÇAR" placeholder="DIGITE METRÔ" clearable align='center'></q-input>
    ...
    return {
      ...
      opcoesTeclado: [
        ...
        },
        {
          ...
          descricao:
            "Essa barra mostra sugestões de palavras conforme você escreve"
        }
      ]
    };
  },
